...
-- Create the Product Reviews temp table.
...
/* ============================================================
   Example 1: AI_COMPLETE - Extract information from reviews
   ============================================================ */

-- Retrieve pros and cons from product reviews.
...
SELECT
    ...
    AI_COMPLETE(
        'snowflake-arctic',
        'Extract 3–5 Pros from the following product review.Do not say pros in every row '||
         REVIEW_TEXT      
    ) AS PROS,
    -- CONS
    AI_COMPLETE(
        'snowflake-arctic',
        'Extract 3–5 Cons from the following product review.Do not say cons in every row '||
         REVIEW_TEXT      
    ) AS CONS
